...
- **Cloud Sync** — Sync across devices via Dropbox, OneDrive, iCloud, or WebDAV
- **Deep Link Import** — `ccswitch://` URL scheme for importing providers, MCP, prompts, and skills
- **Cross-Platform** — Native desktop app for Windows, macOS, and Linux (Tauri 2)
