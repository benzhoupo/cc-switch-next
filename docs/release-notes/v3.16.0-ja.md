...
> 💡 [@EldenPdx](https://github.com/EldenPdx) の PR [#2804](https://github.com/benzhoupo/cc-switch-next/pull/2804) に特別な感謝を: 本機能の Chat ↔ Responses フォーマット変換の実装は、彼の PR の実装を参考にしています。
...
[Releases](https://github.com/benzhoupo/cc-switch-next/releases/latest) から対応バージョンをダウンロードしてください。
