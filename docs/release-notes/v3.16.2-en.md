...
Updated the SSSAiCode preset's website, signup, and API base URLs to the `sssaicodeapi.com` domain, and refreshed its candidate endpoint nodes (default `node-hk.sssaicodeapi.com`, plus `node-hk.sssaiapi.com` and `node-cf.sssaicodeapi.com`) across all eight app presets.
...
- [#1351](https://github.com/benzhoupo/cc-switch-next/pull/1351): add S3-compatible cloud storage sync, thanks @keithyt06.
- [#3215](https://github.com/benzhoupo/cc-switch-next/pull/3215): add OpenCode session usage sync, thanks @nothingness0db.
- [#2709](https://github.com/benzhoupo/cc-switch-next/pull/2709): add the ZenMux Token Plan provider, thanks @Eter365.
- [#3643](https://github.com/benzhoupo/cc-switch-next/pull/3643): add the CherryIN preset provider, thanks @zhibisora.
- [#3818](https://github.com/benzhoupo/cc-switch-next/pull/3818): add the Codex CLI reachability `GET /v1/models` endpoint, thanks @CSberlin.
- [#3426](https://github.com/benzhoupo/cc-switch-next/pull/3426): Usage Dashboard hero redesign, thanks @allenxu09.
- [#3640](https://github.com/benzhoupo/cc-switch-next/pull/3640): drop `tool_choice` when tools is empty, thanks @Postroggy.
- [#3644](https://github.com/benzhoupo/cc-switch-next/pull/3644): preserve Codex custom tool metadata in chat routing, thanks @LanternCX.
- [#3514](https://github.com/benzhoupo/cc-switch-next/pull/3514): always include `reasoning_tokens` in Chat→Responses, thanks @yeeyzy.
- [#3689](https://github.com/benzhoupo/cc-switch-next/pull/3689): skip backup / restore when live is already a proxy placeholder, thanks @YongmaoLuo.
- [#3016](https://github.com/benzhoupo/cc-switch-next/pull/3016): normalize the localhost listen address, thanks @Alexlangl.
- [#3775](https://github.com/benzhoupo/cc-switch-next/pull/3775): normalize Anthropic `system` messages, thanks @Dearli666.
- [#3656](https://github.com/benzhoupo/cc-switch-next/pull/3656): improve error message display in the proxy panel, thanks @lzcndm.
- [#2647](https://github.com/benzhoupo/cc-switch-next/pull/2647): raise the infinite-whitespace threshold 20 → 500, thanks @NiuBlibing.
- [#3702](https://github.com/benzhoupo/cc-switch-next/pull/3702): route the Zhipu quota query to the configured base URL, thanks @YongmaoLuo.
- [#3518](https://github.com/benzhoupo/cc-switch-next/pull/3518): adapt to the MiniMax new balance API and default pricing, thanks @LaoYueHanNi.
- [#3524](https://github.com/benzhoupo/cc-switch-next/pull/3524): fix the Zhipu Coding Plan presets and model probing for versioned endpoints, thanks @makoMakoGo.
- [#3614](https://github.com/benzhoupo/cc-switch-next/pull/3614): use a relative filename for the model catalog, thanks @steponeerror.
- [#3797](https://github.com/benzhoupo/cc-switch-next/pull/3797): fix the Windows tray icon residue after exit, thanks @iAJue.
- [#3457](https://github.com/benzhoupo/cc-switch-next/pull/3457): fix the Windows taskbar icon, thanks @ZhangNanNan1018.
- [#3430](https://github.com/benzhoupo/cc-switch-next/pull/3430): normalize Windows path separators to match subdirectory skill updates, thanks @Ninthless.
- [#3626](https://github.com/benzhoupo/cc-switch-next/pull/3626): disable macOS input auto-capitalization, thanks @ZHLHZHU.
- [#3593](https://github.com/benzhoupo/cc-switch-next/pull/3593): fix Codex VS Code session previews, thanks @xwil1.
- [#3228](https://github.com/benzhoupo/cc-switch-next/pull/3228): align the VS Code wording in the Chinese UI, thanks @Games55k.
- [#3411](https://github.com/benzhoupo/cc-switch-next/pull/3411): refresh the user manual to reflect current app support, thanks @makoMakoGo.
- [#3772](https://github.com/benzhoupo/cc-switch-next/pull/3772): fix README release-note links and sponsor markup, thanks @null-easy.
