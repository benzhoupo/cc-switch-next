...
- [#3789](https://github.com/benzhoupo/cc-switch-next/pull/3789): preserve Codex OAuth auth token on takeover, thanks @codeasier.
- [#2774](https://github.com/benzhoupo/cc-switch-next/pull/2774): fix model / input-token recording on Completions→Anthropic, thanks @LaoYueHanNi.
- [#4069](https://github.com/benzhoupo/cc-switch-next/pull/4069): fix the deadlock on relaunch after an in-app update, thanks @thisTom.
- [#4156](https://github.com/benzhoupo/cc-switch-next/pull/4156): fix duplicate provider terminal sessions on macOS, thanks @thisTom.
- [#3267](https://github.com/benzhoupo/cc-switch-next/pull/3267): fix duplicate YAML keys in the Hermes config, thanks @que3sui.
- [#1479](https://github.com/benzhoupo/cc-switch-next/pull/1479): fix usage script provider credential resolution, thanks @pa001024.
- [#3975](https://github.com/benzhoupo/cc-switch-next/pull/3975): add preset search and sorting, thanks @Nastem.
- [#4183](https://github.com/benzhoupo/cc-switch-next/pull/4183): adjust the preset-provider button appearance and search-box position, thanks @WangJiati.
- [#4077](https://github.com/benzhoupo/cc-switch-next/pull/4077): add claude-mythos-5 model pricing, thanks @osscv.
