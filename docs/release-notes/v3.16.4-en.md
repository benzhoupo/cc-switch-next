...
> | Source             | **[github.com/benzhoupo/cc-switch-next](https://github.com/benzhoupo/cc-switch-next)** |
> | Downloads          | **[GitHub Releases](https://github.com/benzhoupo/cc-switch-next/releases)**        |
> | Author             | **[@benzhoupo](https://github.com/benzhoupo)**                               |
> | Report an Imposter | **[GitHub Issues](https://github.com/benzhoupo/cc-switch-next/issues)**            |
>
...
The seed model pricing now includes GLM-5.2 ([#4385](https://github.com/benzhoupo/cc-switch-next/pull/4385)) and Doubao Seed 2.1 Pro / Turbo, so these models' usage is priced correctly instead of being recorded at zero cost. Doubao prices use Volcengine's official list pricing (converted at roughly 7.14); `cache_creation` stays at 0 because Doubao bills cache storage by time rather than by token writes, and the existing 2.0 rows are retained for historical accounting.

### Kimi For Coding Auto-Compact Window

The Kimi For Coding preset now defaults `CLAUDE_CODE_AUTO_COMPACT_WINDOW` to 262144, matching Kimi's official documentation, and exposes it via `templateValues` so users can customize the value for future models or performance tuning. ([#4401](https://github.com/benzhoupo/cc-switch-next/pull/4401))

### SubRouter Partner Provider

Added SubRouter (`subrouter.ai`, an AI relay aggregator that lets one key reach many models across many providers) as a preset covering all eight managed apps — an Anthropic-format endpoint for Claude Code / Claude Desktop / OpenClaw / Hermes, an OpenAI-compatible `/v1` endpoint (`gpt-5.5`) for Codex and OpenCode, and a Gemini-compatible `/v1beta` endpoint (`gemini-3.5-flash`) for Gemini CLI — with its own brand icon, a gold partner star, four-language promotion copy, and a referral signup link prefilled to the API-key registration page (`?aff=l3ri`). ([#4522](https://github.com/benzhoupo/cc-switch-next/pull/4522))
...
- [#3817](https://github.com/benzhoupo/cc-switch-next/pull/3817): decompress the request body before forwarding and add zstd support, thanks @chenx-dust.
- [#4583](https://github.com/benzhoupo/cc-switch-next/pull/4583): fix the Copilot / Codex OAuth modules bypassing the global proxy and causing Claude model 400s, thanks @zymouse.
- [#4589](https://github.com/benzhoupo/cc-switch-next/pull/4589): add local proxy request overrides (custom headers and request body), thanks @mfzzf.
- [#4575](https://github.com/benzhoupo/cc-switch-next/pull/4575): add an in-app recovery screen for a too-new database version, thanks @SaladDay.
- [#4556](https://github.com/benzhoupo/cc-switch-next/pull/4556): wire dark mode into the JsonEditor in several places, thanks @TanKimzeg.
- [#4438](https://github.com/benzhoupo/cc-switch-next/pull/4438): add a live end time for custom date ranges, thanks @arichyx.
- [#3950](https://github.com/benzhoupo/cc-switch-next/pull/3950): add Windows ARM64 release support, thanks @MOON-DREAM-STARS.
- [#4401](https://github.com/benzhoupo/cc-switch-next/pull/4401): add CLAUDE_CODE_AUTO_COMPACT_WINDOW to the Kimi For Coding preset, thanks @cyijun.
- [#4323](https://github.com/benzhoupo/cc-switch-next/pull/4323): fix the Skills management and model-config interaction display, thanks @thisTom.
- [#3431](https://github.com/benzhoupo/cc-switch-next/pull/3431): align Claude MCP paths to the custom config directory, thanks @makoMakoGo.
- [#4159](https://github.com/benzhoupo/cc-switch-next/pull/4159): skip Chat tool calls missing function names, thanks @hueifeng.
- [#4385](https://github.com/benzhoupo/cc-switch-next/pull/4385): add glm-5.2 pricing, thanks @arichyx.
- [#4079](https://github.com/benzhoupo/cc-switch-next/pull/4079): support importing model pricing from models.dev, thanks @kingcanfish.
- [#4315](https://github.com/benzhoupo/cc-switch-next/pull/4315): fix preset results not being clickable / selectable after search, thanks @RuixeWolf.
- [#4316](https://github.com/benzhoupo/cc-switch-next/pull/4316): prevent duplicate Codex base_url entries, thanks @jeffwcx.
- [#4140](https://github.com/benzhoupo/cc-switch-next/pull/4140): make the provider terminal honor the user shell, thanks @zkforge.
- [#4113](https://github.com/benzhoupo/cc-switch-next/pull/4113): show the source file name in the session detail header, thanks @xu-song.
- [#4160](https://github.com/benzhoupo/cc-switch-next/pull/4160): restore cached Codex tool-call fields, thanks @chen-985211.
- [#4239](https://github.com/benzhoupo/cc-switch-next/pull/4239): strip the effort parameter when thinking:disabled on DeepSeek endpoints, thanks @maskshell.
- [#4165](https://github.com/benzhoupo/cc-switch-next/pull/4165): reset scroll when switching settings tabs, thanks @Muleizhang.
- [#4522](https://github.com/benzhoupo/cc-switch-next/pull/4522): add the SubRouter provider preset, thanks @abingyyds.
...
Visit [Releases](https://github.com/benzhoupo/cc-switch-next/releases/latest) and download the build for your system.
