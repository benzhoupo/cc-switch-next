...
**[中文更新说明 Chinese Documentation →](https://github.com/benzhoupo/cc-switch-next/blob/main/docs/release-notes/v3.6.0-zh.md)**
...
- **Windows**: `CC Switch Next_3.6.0_x64-setup.exe` (NSIS) or `CC Switch Next_3.6.0_x64_en-US.msi` (MSI)
- **Portable**: `CC Switch Next_3.6.0_x64-setup.exe` (NSIS)
...
**Full Changelog**: https://github.com/benzhoupo/cc-switch-next/compare/v3.5.1...v3.6.0
