# CC Switch Next v3.6.1

> Stability improvements and user experience optimization (based on v3.6.0)

**[中文更新说明 Chinese Documentation →](https://github.com/benzhoupo/cc-switch-next/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- **Windows**: `CC Switch Next_3.6.1_x64-setup.exe` (NSIS) or `CC Switch Next_3.6.1_x64_en-US.msi` (MSI)
- **Portable**: `CC Switch Next_3.6.1_x64-setup.exe` (NSIS)

### 📚 Documentation

- [中文文档 (Chinese)](https://github.com/benzhoupo/cc-switch-next/blob/main/README_ZH.md)
- [English Documentation](https://github.com/benzhoupo/cc-switch-next/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/benzhoupo/cc-switch-next/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/benzhoupo/cc-switch-next/compare/v3.6.0...v3.6.1
...
**Project Repository**: https://github.com/benzhoupo/cc-switch-next
