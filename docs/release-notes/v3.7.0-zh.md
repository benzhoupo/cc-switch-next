...
访问 [Releases](https://github.com/benzhoupo/cc-switch-next/releases/latest) 下载：
...
- [@benzhoupo](https://github.com/benzhoupo) - 从开发沦为 issue 回复机
- 社区成员的测试和反馈
...
- **问题反馈**：[GitHub Issues](https://github.com/benzhoupo/cc-switch-next/issues)
- **讨论**：[GitHub Discussions](https://github.com/benzhoupo/cc-switch-next/discussions)
