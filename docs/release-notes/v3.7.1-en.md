...
Visit [Releases](https://github.com/benzhoupo/cc-switch-next/releases/latest) to download the latest version
...
Visit [Releases](https://github.com/benzhoupo/cc-switch-next/releases/latest) to download:
...
- [@benzhoupo](https://github.com/benzhoupo) - From developer to issue responder
...
- **Issues**: [GitHub Issues](https://github.com/benzhoupo/cc-switch-next/issues)
- **Discussions**: [GitHub Discussions](https://github.com/benzhoupo/cc-switch-next/discussions)
