...
- **Windows**: `CC Switch Next_3.8.0_x64-setup.exe` (NSIS) or `CC Switch Next_3.8.0_x64_en-US.msi` (MSI)
...
- [@benzhoupo](https://github.com/benzhoupo) - Bug fixes and feature enhancements
...
- **Issue Reports**: [GitHub Issues](https://github.com/benzhoupo/cc-switch-next/issues)
