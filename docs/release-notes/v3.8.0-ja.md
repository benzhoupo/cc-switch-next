...
[Releases](https://github.com/benzhoupo/cc-switch-next/releases/latest) から入手:
...
- [@benzhoupo](https://github.com/benzhoupo) - バグ修正と機能拡張
...
- **Issue**: [GitHub Issues](https://github.com/benzhoupo/cc-switch-next/issues)
