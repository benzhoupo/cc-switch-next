...
## What is CC Switch Next

CC Switch Next is a cross-platform desktop application designed for developers who use AI tools. It helps you centrally manage configurations for **Claude Code**, **Claude Desktop**, **Codex**, **Gemini CLI**, **OpenCode**, **OpenClaw**, and **Hermes**.
...
CC Switch Next solves these problems through a unified interface.
...
CC Switch Next is built with a modern technology stack:
