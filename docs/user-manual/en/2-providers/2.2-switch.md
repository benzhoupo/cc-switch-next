...
2. CC Switch Next updates the configuration file
...
1. Right-click the CC Switch Next icon in the system tray
...
When switching providers, CC Switch Next modifies the following files:
