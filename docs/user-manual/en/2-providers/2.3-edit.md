...
CC Switch Next provides rich icon customization features:
...
This ensures CC Switch Next and CLI tool configurations stay in sync.
...
When adding a provider, CC Switch Next automatically extracts endpoint URLs from the configuration.
