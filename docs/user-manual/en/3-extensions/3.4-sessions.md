...
**On macOS:**
- CC Switch Next launches your preferred terminal with the resume command
...
3. CC Switch Next launches the Claude terminal session in the selected directory
