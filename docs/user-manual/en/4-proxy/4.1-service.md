...
sequenceDiagram
    ...
    participant Proxy as Local Proxy (CC Switch Next)
...
After starting the proxy and enabling app takeover, CC Switch Next modifies app configurations:
...
When stopping the proxy, CC Switch Next will:
