...
CC Switch Next 支持 `ccswitch://` 深度链接协议，可以通过链接一键导入配置。
...
使用 CC Switch Next 官方提供的在线深度链接生成工具更方便。
...
1. 系统会询问是否打开 CC Switch Next
2. 确认后 CC Switch Next 打开
3. 显示导入确认对话框
4. 确认导入
...
CC Switch Next 安装时会自动注册 `ccswitch://` 协议。
