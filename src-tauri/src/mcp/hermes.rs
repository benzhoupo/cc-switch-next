...
//!
//! Handles conversion between CC Switch Next unified MCP format and Hermes config.yaml format.
//!
//! ## Format mapping
//!
//! | CC Switch Next unified (JSON)                        | Hermes config.yaml (YAML)       |
//! |-------------------------------------------------|---------------------------------|
...
/// CC Switch Next has no OAuth UI, but losing the field on round-trip downgrades
...
// ============================================================================
// Format Conversion: CC Switch Next -> Hermes
// ============================================================================

/// Convert CC Switch Next unified format to Hermes format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: Hermes -> CC Switch Next
// ============================================================================

/// Convert Hermes format to CC Switch Next unified format
///
/// Conversion rules:
...
/// `existing` — this prevents CC Switch Next from overwriting user customizations.
...
mod tests {
    ...
    fn test_merge_preserves_auth_field() {
        ...
        assert_eq!(
            merged["auth"], "oauth",
            "auth declaration must survive CC Switch Next round-trip"
        );
    }
