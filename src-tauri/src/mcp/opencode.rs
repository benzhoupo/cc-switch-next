...
//!
//! 本模块处理 CC Switch Next 统一 MCP 格式与 OpenCode 格式之间的转换。
//!
//! ## 格式差异
//!
//! | CC Switch Next 统一格式    | OpenCode 格式       |
//! |----------------------|---------------------|
...
// ============================================================================
// Format Conversion: CC Switch Next → OpenCode
// ============================================================================

/// Convert CC Switch Next unified format to OpenCode format
///
/// Conversion rules:
...
// ============================================================================
// Format Conversion: OpenCode → CC Switch Next
// ============================================================================

/// Convert OpenCode format to CC Switch Next unified format
///
/// Conversion rules:
