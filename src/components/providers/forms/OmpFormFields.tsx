  ...
  return (
    <>
      <div className="space-y-2">
        <FormLabel htmlFor="omp-api-mode">{t("omp.form.apiMode")}</FormLabel>
        <Select value={api} onValueChange={onApiChange}>
          <SelectTrigger id="omp-api-mode" className="w-full">
            <SelectValue placeholder={t("omp.form.selectApi")} />
          </SelectTrigger>
          <SelectContent>
      ...
      <div className="space-y-2">
        <FormLabel htmlFor="omp-base-url">{t("omp.form.baseUrl")}</FormLabel>
        <Input
          id="omp-base-url"
          value={baseUrl}
      ...
      <div className="space-y-2">
        <div className="flex items-center justify-between">
          <FormLabel>{t("omp.form.models")}</FormLabel>
